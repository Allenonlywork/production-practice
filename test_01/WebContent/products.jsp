		...
		<div class="container">
			<div class="col-md-4 products-left">
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="image/6.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4><a href="single">occaecat cupidatat</a></h4>
								<div class="rating">
									<div class="rating-left">
										<img src="image/2.png" alt=" " class="img-responsive">
									</div>
									<div class="rating-left">
										<img src="image/2.png" alt=" " class="img-responsive">
									</div>
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="image/26.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="image/11.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
				...
				<div class="men-position animated wow slideInUp" data-wow-delay=".5s">
					<a href="single"><img src="image/27.jpg" alt=" " class="img-responsive" /></a>
			...
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					...
					<div class="products-right-grids-position animated wow slideInRight" data-wow-delay=".5s">
						<img src="image/18.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img src="${pageContext.request.contextPath }${p.pimage }" alt=" " class="img-responsive"></a>
								<div class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single?pid=${p.pid }">Quick View</a>
								</div>
							...
							<h4><a href="single">${p.pname }</a></h4>
							<p style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis">${p.desc }</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p> <span class="item_price">￥${p.shopPrice }</span><i>￥${p.marketPrice }</i><a class="item_add" href="#">add to cart </a></p>
							</div>
						</div>
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
					...
					<div class="footer-grid-left">
						<a href="single"><img src="image/13.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single"><img src="image/14.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single"><img src="image/15.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single"><img src="image/16.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single"><img src="image/13.jpg" alt=" " class="img-responsive" /></a>
					</div>
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".8s">
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single"><img src="image/9.jpg" alt=" " class="img-responsive" /></a>
						</div>
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single"><img src="image/10.jpg" alt=" " class="img-responsive" /></a>
						</div>
						<div class="footer-grid-sub-grid-right">
