		...
		<div class="row">
			<div id="main-content" class="col-md-8">
				<div class="product">
					<div class="col-md-6">
						<div class="image">
							<img src="/images/${requestScope.product.imgUrl}" />
					...
					<div class="col-md-6">
						<div class="caption">
							<div class="name"><h3>${requestScope.product.name}</h3></div>
							<div class="info">
								<ul>
									<li>品牌: ${requestScope.product.brand.name}</li>
									<li>编号: ${requestScope.product.pid}</li>
								</ul>
							</div>
							<div class="price">${requestScope.product.price}<span>${requestScope.product.originalPrice}</span></div>
							<div class="options">
								AVAILABLE OPTIONS
								<select>
				...
				<div class="product-related">
					...
					<div class="products">
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="product">
								<div class="image"><a href="product"><img src="/images/iphone.png" /></a></div>
								<div class="buttons">
						...
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="product">
								<div class="image"><a href="product"><img src="/images/galaxy-s4.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
						...
						<div class="col-lg-4 col-md-4 col-xs-12">
							<div class="product">
								<div class="image"><a href="product"><img src="/images/galaxy-note.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="product">Aliquam erat volutpat</a></div>
									<div class="price">$122<span>$98</span></div>
